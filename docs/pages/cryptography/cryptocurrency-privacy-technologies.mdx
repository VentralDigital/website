...
<ArticleCards>
  ...
  <ArticleCard image title="Bulletproofs" subtitle="Soon" href="#from-zerocoin-to-firo">
    <>![Thumbnail](./thumbnail-bulletproofs.jpg)</>
  </ArticleCard>
  <ArticleCard image title="Lelantus" subtitle="Soon" href="#from-zerocoin-to-firo">
    <>![Thumbnail](./thumbnail-lelantus.jpg)</>
  </ArticleCard>
...
| <R reference='Anonymity'/>       |$`-`$<R reference='ZCN'/>|$`-`$<R reference='SIG'/>|$`-`$<R reference='LEL'/>|$`color(green)("Yes")`$<R reference='SPA'/>|
...
<Callout type="warning">
  The comparison table is a work-in-progress.

  **TODO**
  * Performance measurements on standardized hardware?
  * Measuring auditability? Under what assumptions?
  * Actual usage of protocol? Effective anonymity set sizes/growth?
  * Light wallet support? Trusting full nodes? Info leakage?
  * ...
</Callout>
