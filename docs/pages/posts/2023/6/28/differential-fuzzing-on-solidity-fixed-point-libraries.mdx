...
<Callout type="info">
  This is a guest post by [Wu Enbang (aka 0xNorman)](https://twitter.com/Normanrockon) created as part of [patrickd’s writing mentorship](https://twitter.com/patrickd_de/status/1646941356277788672).
</Callout>

<p className="text-xs text-right">June 28, 2023 by [0xNorman](/about#0xnorman)</p>
